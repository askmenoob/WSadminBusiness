...
export const CAPABILITIES = ['TENANT_READ','TENANT_MANAGE','CUSTOMER_WRITE','SERVICE_WRITE','STAFF_WRITE','BOOKING_WRITE','SETTINGS_WRITE','SYSTEM_ADMIN'] as const;
...
const grants: Record<Role, ReadonlySet<Capability>> = {
  ...
  TENANT_OWNER: new Set(['TENANT_READ','TENANT_MANAGE','CUSTOMER_WRITE','SERVICE_WRITE','STAFF_WRITE','BOOKING_WRITE','SETTINGS_WRITE']),
  ADMIN: new Set(['TENANT_READ','TENANT_MANAGE','CUSTOMER_WRITE','SERVICE_WRITE','STAFF_WRITE','BOOKING_WRITE','SETTINGS_WRITE']),
  MANAGER: new Set(['TENANT_READ','CUSTOMER_WRITE','SERVICE_WRITE','STAFF_WRITE','BOOKING_WRITE']),
