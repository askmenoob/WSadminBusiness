...
class Repo implements CalendarRepository{async snapshot(t:string,v:any,f:Date,to:Date){return{tenantId:t,locationId:null,view:v,from:f,to,rows:[],bookings:[],blocks:[]};}}
