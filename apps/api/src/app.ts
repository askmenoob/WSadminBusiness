...
import { createCustomerRepository, createPool, createServiceRepository, createStaffRepository, createStaffScheduleRepository, probeDatabase } from '@wsadmin-business/database';
...
export function buildApp(options:{enableDevRbacProbe?:boolean;customerRepository?:import('@wsadmin-business/customers').CustomerRepository;serviceRepository?:import('@wsadmin-business/services').ServiceRepository;staffRepository?:import('@wsadmin-business/staff').StaffRepository;staffScheduleRepository?:import('@wsadmin-business/staff').StaffScheduleRepository}={}) {
