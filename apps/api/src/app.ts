...
import { createCustomerRepository, createPool, probeDatabase } from '@wsadmin-business/database';
import { registerCustomerRoutes } from './customer-routes.js';
export function buildApp(options:{enableDevRbacProbe?:boolean;customerRepository?:import('@wsadmin-business/customers').CustomerRepository}={}) {
