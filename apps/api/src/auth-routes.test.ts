...
const config:AuthenticationConfig={mode:'GOOGLE',appUrl:'http://localhost:15281',clientId:'client-id',clientSecret:'client-secret',redirectUri:'http://localhost:15280/api/v1/auth/google/callback',secureCookies:false,sessionTtlMs:60_000};
